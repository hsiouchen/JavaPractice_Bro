...
public class GUI_BorderLayout {
	...
	GUI_BorderLayout() {
		...
		//frame.setLayout(new BorderLayout());		// SET LAYOUT: BorderLayout
		frame.setLayout(new BorderLayout(10, 10));	// SET margin between components
		...
		frame.add(panel1, BorderLayout.NORTH); // SET BorderLayout Direction
